...
public interface TeamsApi {
    ...
    @Operation(summary = "Get all teams", description = "", tags={ "Operations about Team" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "successful operation", content = @Content(mediaType = "appication/json", array = @ArraySchema(schema = @Schema(implementation = Team.class)))),
