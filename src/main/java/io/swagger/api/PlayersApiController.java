...
public class PlayersApiController implements PlayersApi {
    @Autowired
    private io.swagger.service.playerService playerService;
    ...
    public ResponseEntity<List<Player>> getAllPlayers() {
        ...
        if (accept != null && accept.contains("application/xml") && !players.isEmpty()) {
            return new ResponseEntity<List<Player>>(players, HttpStatus.OK);
        }

        if (accept != null && accept.contains("application/json") && !players.isEmpty()) {
            return new ResponseEntity<List<Player>>(players, HttpStatus.OK);
        }

        return new ResponseEntity<List<Player>>(HttpStatus.NOT_IMPLEMENTED);
    }
